...
- source-of-truth: `docs/06-developer/manual-review-checkpoints.md`, `docs/06-developer/create-domain-ownership-map.md`, `docs/06-developer/traceability-matrix.md`
