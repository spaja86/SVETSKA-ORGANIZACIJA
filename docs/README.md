...
3. `03-product/` — produktna vizija, zahtevi, prioriteti, putanje korisnika i putokaz razvoja
...
6. `06-developer/` — razvojne smernice, create upravljanje, struktura repozitorijuma, release vrata i ADR
